...
//go:generate mockgen -package mocks -destination mocks/mocks.go github.com/fx2y/learn-web-service-with-golang/internal/crawler URLGetter,PrivateNetworkDetector,Graph,Indexer
