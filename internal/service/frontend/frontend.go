...
//go:generate mockgen -package mocks -destination mocks/mocks.go github.com/fx2y/learn-web-service-with-golang/internal/service/frontend GraphAPI,IndexAPI
//go:generate mockgen -package mocks -destination mocks/mock_indexer.go github.com/fx2y/learn-web-service-with-golang/internal/textindexer/index Iterator
