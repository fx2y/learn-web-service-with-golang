...
import (
	"context"
	"github.com/fx2y/learn-web-service-with-golang/internal/bspgraph"
	"github.com/fx2y/learn-web-service-with-golang/internal/linkgraph/graph"
	pr "github.com/fx2y/learn-web-service-with-golang/internal/pagerank"
...
//go:generate mockgen -package mocks -destination mocks/mocks.go github.com/fx2y/learn-web-service-with-golang/internal/service/pagerank GraphAPI,IndexAPI
//go:generate mockgen -package mocks -destination mocks/mock_iterator.go github.com/fx2y/learn-web-service-with-golang/internal/linkgraph/graph LinkIterator,EdgeIterator
