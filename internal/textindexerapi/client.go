...
//go:generate mockgen -package mocks -destination mocks/mock.go github.com/fx2y/learn-web-service-with-golang/internal/textindexerapi/proto TextIndexerClient,TextIndexer_SearchClient
