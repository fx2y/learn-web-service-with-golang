...
//go:generate mockgen -package mocks -destination mocks/mocks_api.go github.com/fx2y/learn-web-service-with-golang/internal/dbspgraph/proto JobQueue_JobStreamServer
