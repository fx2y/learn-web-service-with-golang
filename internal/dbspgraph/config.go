...
import (
	"github.com/fx2y/learn-web-service-with-golang/internal/dbspgraph/job"
...
//go:generate mockgen -package mocks -destination mocks/mocks_serializer.go github.com/fx2y/learn-web-service-with-golang/internal/dbspgraph Serializer
//go:generate mockgen -package mocks -destination mocks/mocks_job.go github.com/fx2y/learn-web-service-with-golang/internal/dbspgraph/job Runner
