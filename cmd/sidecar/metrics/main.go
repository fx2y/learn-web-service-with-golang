...
import (
	"fmt"
	"github.com/fx2y/learn-web-service-with-golang/cmd/sidecar/metrics/internal/collector"
	"github.com/fx2y/learn-web-service-with-golang/cmd/sidecar/metrics/internal/publisher"
	"github.com/fx2y/learn-web-service-with-golang/cmd/sidecar/metrics/internal/publisher/expvar"
	"log"
	"net/http"
	_ "net/http/pprof"
	"os"
